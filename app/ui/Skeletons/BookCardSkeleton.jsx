...
const BookCardSkeleton = () => {
    return (
        <div className="flex flex-row rounded-lg bg-main-color-600 animate-pulse">
            <div className="rounded-t-lg md:rounded-none md:rounded-l-lg relative w-full h-48 bg-main-color-300" />

            {/* Contenido textual del Skeleton */}
