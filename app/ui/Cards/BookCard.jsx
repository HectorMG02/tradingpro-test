  ...
  return (
    <div
      className="flex flex-col h-52 md:max-w-xl md:flex-row
        transition-transform duration-500 ease-in-out transform hover:scale-105 overflow-hidden cursor-pointer hover:shadow-xl bg-blue-chill-800 
        rounded shadow-2xl
    "
      onClick={showBookDetails}
    >
      <div
        className="rounded-t-lg md:rounded-none md:rounded-l-lg relative md:w-300px h-full bg-blue-chill-900 
            rounded shadow-2xl"
      >
        <Image
          src={book.cover}
      ...
      <div className="flex flex-col justify-start p-6">
        <div className="flex justify-between items-start">
          <h5 className="text-xl text-white font-medium">{book.title}</h5>
          <HearthIcon
